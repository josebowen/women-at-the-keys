...
- Search by composer, work title, country, and key
...
- Tekla Bądarzewska, *A Maiden's Prayer* (1856) — the century's best-selling piano sheet music
- Estelle D. Ricketts, *Rippling Spring Waltz* (1893) — earliest known published piano solo by a Black woman
- Leokadiya Kashperova, Stefania Turkevych, Carmela Mackenna, Nora Holt, and other recovered figures

## Files

- `index.html` — the complete application (open directly in any browser)
- `data/works.json` — the underlying dataset (composer, dates, country, title, key, year, source URL) for reuse in other projects
...
Data compiled from public-domain and openly licensed sources. Database compilation © 2026, shared for educational and research use (CC BY 4.0 suggested).
